    ...
    postStatus(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield this.createAuthTokenProvider().isvalidateAuth(event.authToken)) {
                ...
                let followersAliases = yield this.createFollowProvider().getJustFollowersAlias(event.newStatus.user.alias);
                followersAliases.forEach((alias) => __awaiter(this, void 0, void 0, function* () {
                    yield this.createFeedProvider().putFeed(alias, event.newStatus);
                }));
                yield this.createAuthTokenProvider().putAuthToken(event.authToken);
