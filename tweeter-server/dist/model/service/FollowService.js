...
class FollowService extends ServiceFactory_1.ServiceFactory {
    ...
    getFolloweesCount(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                followeesCount = yield this.createUserProvider().getFollowingsCount(event.user.alias);
            }
            catch (err) {
    ...
    getFollowersCount(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let isSuccess = false;
            try {
                followersCount = yield this.createUserProvider().getFollowersCount(event.user.alias);
                isSuccess = true;
            }
            catch (err) {
                throw new Error("[Bad Request] " + err.message);
    ...
    follow(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (yield this.createAuthTokenProvider().isvalidateAuth(event.authToken)) {
                ...
                yield this.createUserProvider().increaseFollowingCount(event.loginUser.alias);
                yield this.createUserProvider().increaseFollowersCount(event.userToFollow.alias);
    ...
    event) {
        return __awaiter(this, void 0, void 0, function* () {
            if (yield this.createAuthTokenProvider().isvalidateAuth(event.authToken)) {
                ...
                yield this.createUserProvider().decreaseFollowingCount(event.loginUser.alias);
                yield this.createUserProvider().decreaseFollowersCount(event.userToUnfollow.alias);
