import {loadMoreItemsRequest, LoadMoreFeedStoryResponse } from "tweeter-shared"; 
...
export const handler = async (event:loadMoreItemsRequest):Promise<LoadMoreFeedStoryResponse >=>{
        ...
        return new StatusService(await new DynamoDBDaoFactory()).loadMoreStoryItems(request); 
